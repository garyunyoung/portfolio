    ...
    <section id="about" className="about">
      <div className="about__content">
        ...
        <p className="about__description">
          I'm a front-end developer who is interested in
          contributing towards high-quality web and mobile
          experiences for anyone and everyone.
        </p>
        <div className="about__personality-list-container">
          <h4 className="about__list-header">
            Things I like:
          </h4>
          <ul className="about__personality-list">
            ...
            <li>
              Writing clear, reusuable, and reliable code
            </li>
        ...
        <div className="about__resource-list-container">
          ...
          <ul className="about__resource-list">
            ...
            <ResourceListItem
              ...
              href="https://www.executeprogram.com/"
            />
            <ResourceListItem
              text="Advent of Code"
